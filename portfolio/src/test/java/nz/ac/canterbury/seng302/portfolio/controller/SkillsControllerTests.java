...
class SkillsControllerTests {
    ...
    void getOtherSkillsWithInvalidUserReturnsRedirectToProfile() throws Exception {
        ...
        mockMvc.perform(get("/portfolio-2-skill?skill=skill&portfolioLinks=T"))
    ...
    void getOtherSkillsWithSameUserReturnsRedirectToOwnSkills() throws Exception {
        ...
        mockMvc.perform(get("/portfolio-1-skill?skill=skill&portfolioLinks=T"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/portfolio-skill?skill=skill&portfolioLinks=T"));
    }
}
