...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity security) throws Exception
    {
        ...
        security
            .addFilterBefore(new JwtAuthenticationFilter(), BasicAuthenticationFilter.class)
                .authorizeRequests()
                    .antMatchers(HttpMethod.GET, LOGIN, "/logout", "/styles/**", "/register", "/error", "/favicon.ico", "/", "/scripts/theme.js")
                    .permitAll()
                    .and()
                .authorizeRequests()
                    .anyRequest()
    ...
    {
        web.ignoring().antMatchers(LOGIN, "/logout", "/styles/**", "/register", "/favicon.ico", "/", "/scripts/theme.js");
    }
}